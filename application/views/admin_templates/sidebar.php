    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            ...
            <div class="title">
                ...
                $id = $user['id'];
                ?>
                <p class="h5 ml-2"><a href="<?= base_url('admin/editprofile/') . $id; ?>"><?= $user['fullname']; ?></a></p>
                <p class="ml-2">
                    <?php
                    $role = $user['role_id'];
                    if ($role == '1') {
        ...
        <ul class="list-unstyled">
            ...
            <?php
            $currenttitle = 'manageuser';
            if ($title == $currenttitle) : ?>
                <li class="active">
                    <a href="<?= base_url('manageuser'); ?>">
                        <i class="icon-user-1"></i>Manage User
                    </a>
                </li>
            <?php else : ?>
                <li>
