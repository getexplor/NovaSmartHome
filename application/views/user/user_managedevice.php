                    ...
                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Device Category</th>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php echo anchor(
                                                'usermanagedevices/edit_device/' . $dev->id,
                                            ...
                                            ?>
                                            <?php echo anchor(
                                                'usermanagedevices/delete_device/' . $dev->id,
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url() . 'usermanagedevices/create_device'; ?>">
