<div class="page-content">
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('managedevice'); ?>">Manage Device</a></li>
    ...
    <div class="col-lg-12">
        ...
        <?php foreach ($device as $dev) { ?>
            <form method="post" action="<?php echo base_url() . 'managedevice/update_device'; ?>">
                <div class="form-group">
                    ...
                    <select name="devicecategory" class="form-control" value="<?php echo $dev->device_category ?>">
                        <?php
